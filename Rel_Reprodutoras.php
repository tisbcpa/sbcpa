...
<Title>Reprodutoras por Ano</Title>
<Style>
...
<?
	$sql = "Select  b.IdCachorro, b.NoCachorro, sum(a.NrMachosVivos) as Machos, sum(a.NrFemeasVivas) as Femeas, count(b.NoCachorro) as Ninhada  From  TBNinhada as a, TBCachorro as b where a.IdCachorroMae = b.IdCachorro and Year(a.DaNascimento) = $Ano group by b.NoCachorro Order By b.NoCachorro";
	$sql_result = mysql_query($sql,$Conn) or die("<p class='MsgErro'>Query invalida: " . mysql_error() . "</p>");
	

	echo("<center><br><span class=Titulo>Reprodutoras em $Ano</span><br><br></center>");
