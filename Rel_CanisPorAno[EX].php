...
<Title>Canis Registrados Por Ano</Title>
<Style>
...
<?
	$sql = "select IdCanil,NoCanil, NoProprietarioCanil, SgUF, DtFiliacao from TBCanil Where year(dtFiliacao) = $Ano";
	...
	{
		$Soma = $Soma + 1;
		echo("<tr><td align=Left><a href='Canil_Formulario.php?Id=$row[IdCanil]' Target='new'>$row[NoCanil]</a></td><td align=Center>$row[NoProprietarioCanil]</td><td align=Center>$row[SgUF]</td><td align=center>" . FormatarDataTela($row["DtFiliacao"]) . "</td></tr>");
	}
