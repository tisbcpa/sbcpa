...
require("Funcoes/Ninhada.php");
	...
	if ($Action != "D")
	{
		...
		$NrAnoNinhada = $_POST["NrAnoNinhada"];
		...
		*/
		...
		if ($Action != "U")
		{CadastrarNinhada($DtNascimento, $IdCanil, $NrMachos, $NrMachosVivos, $NrFemeas, $NrFemeasVivas, $TxConsaguinidade, $IDPai, $IDMae, $Filhotes, $NrAnoNinhada, $IDClube);}
		else
		{AlterarNinhada($Id, $DtNascimento, $IdCanil, $NrMachos, $NrMachosVivos, $NrFemeas, $NrFemeasVivas, $TxConsaguinidade, $IDPai, $IDMae, $Filhotes, $NrAnoNinhada, $IDClube);}
	}
	else
	{
		$IdNinhada = $_GET["Id"];
		ExcluirNinhadaIdNinhada($IdNinhada);
	}
?>
<Script>
function Redirect()
