...
<Title>Cachorros por Intervalo de Registro</Title>
<Style>
...
<?
	...
	$sql = "select a.nuregistronacional, a.nocachorro, a.DaNascimento from tbcachorro as a where a.nuregistronacional >= '$NuInicio' and a.nuregistronacional <= '$NuFinal' Order by a.nuregistronacional";
	//die($sql);

	$sql_result = mysql_query($sql,$Conn) or die("<p class='MsgErro'>Query invalida: " . mysql_error() . "</p>");
	

	echo("<center><br><span class=Titulo>Relação de Cachorros por Intervalo de N° SBCPA</span><br><br></center>");
	echo("<table border=0 align=center>");
	echo("<tr class=Titulo><td align=Center Width=150>N° SBCPA</td><td align=Center Width=300>Nome</td><td align=Center Width=100>Data de Nascimento</td></tr>");
	...
	while ($row = mysql_fetch_array($sql_result))
	{
		...
		echo("<tr><td align=Left>$row[nuregistronacional]</td><td>$row[nocachorro]</td><td align=Center>".  FormatarDataTela($row["DaNascimento"]) . "</td></tr>");
	}
