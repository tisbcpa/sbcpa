...
<Title>Situação Financeira de Canis</Title>
<Style>
...
<Form name="Formulario">
	<table align="center">
		<tr class="Normal">
			<td>Selecione a Opção:</td>
			<td>
			<select name="NrAno" onChange="document.Formulario.submit()">
			<?
				echo("<option value=1>Canis com Débitos</option>");
				echo("<option value=0>Canis sem Débitos</option>");
			?>
			</select>
			</td>
		</tr>
...
<?
	$Situacao = str_replace("1","Com Débitos",$Ano);
	$Situacao = str_replace("0","Sem Débitos",$Situacao);
