...
<Title>Mapa de Ninhada de Canil no Ano</Title>
<Style>
...
<Form name="Formulario" Method="Post">
	<table align="center">
		<tr class="Normal">
			<td>Canil:</td>
			<td>
			<select name="IdCanil" onChange="document.Formulario.submit()">
			<?
	...
	<script>document.Formulario.IdCanil.value = '<? echo($IdCanil);?>';</script>
</Form>


<?
	$sql = "select Left(NuNinhada,4) Ninhada, Right(NuNinhada,4) Ano, DaNascimento, NrMachosVivos, NrFemeasVivas from TBNinhada where Right(NuNinhada,4) = '$Ano' and IdCanil = $IdCanil";
