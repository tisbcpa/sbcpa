...
<Title>Consulta Pai e Seus Filhotes por Período</Title>
<Style>
...
<?
	...
	$sql = "Select Sum(NrMachosVivos) as NrMachosVivos, Sum(NrFemeasVivas) as NrFemeasVivas From TBCachorro as a Inner Join TBNinhada as b on a.IDCachorro = b.IDCachorroPai Where a.IDCachorro = $IdPai and b.DaNascimento Between '$DTInicio2'  and '$DTTermino2' Group By IDCachorro";
	...
	$UF[1] = "Machos";
	$UF[2] = "Fêmeas";
	echo("<center><br><span class=Titulo>Consulta Pai e Seus Filhotes por Período</span><br><br></center>");
