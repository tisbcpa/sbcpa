...
if (ToolBar_Supported != null && ToolBar_Supported == true)
{
	...
	setDefaultICPMenuColor("#BFCCC9", "#ffffff", "#000000");
...
function AbrirRel(n)
{
	...
	pag[36] = "http://www.sbcpa.com.br/Extranet/Exposicao_Importar.asp";
	pag[37] = "Rel_Personalizado2.php";
	
	if (n == 36){
		window.open(pag[n],'','width=550, height=300, left=100, toolbar=no, top=60, menubar=no, scrollbars=no');
	}
	else{
