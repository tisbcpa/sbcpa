...
<Title>Relação de Proprietários por Ordem Alfabética</Title>
<Style>
...
<Span class=Titulo>Relação de Proprietários em Ordem Alfabética</Span><br><br>

<?
	require("Funcoes/Conexao.php");

	$sql = "select * from TBProprietario Order By NOProprietario";
...
?>	
		...
		while ($row = mysql_fetch_array($sql_result))
		{
			...
			echo("<tr>");
			echo("<td><B>Endereço:</B></td><td>$row[EdProprietario]</td>");
			echo("<tr>");
			...
			echo("<tr>");
			echo("<td><B>Associado?</B></td><td>". str_replace("0","Não",str_replace("1","Sim",$row["TPAssociado"])) ."</td>");
			echo("<tr>");
