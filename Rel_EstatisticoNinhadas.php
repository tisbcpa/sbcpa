...
<?
	...
	while ($row = mysql_fetch_array($sql_result))
	{
		...
		echo("<tr><td><a href='Canil_Formulario.php?Id=$row[IdCanil]' Target='new'>$row[NoCanil]</a></td><td align=Center>$row[Ninhadas]</td><td align=Center>$row[Machos]</td><td align=Center>$row[Femeas]</td></tr>");
	}
