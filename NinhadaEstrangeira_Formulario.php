...
function VerificarConsaguinidade(IdMae,IdPai)
{
	...
	document.Formulario.TxConsaguinidade.value = Taxa;
}
...
function ValidarQtdeFilhotes()
{
	...
	document.Formulario.NrMachosVivos.value = QtdeM;
	document.Formulario.NrFemeasVivas.value = QtdeF;
	document.Formulario.NrMachos.value = QtdeM;
	document.Formulario.NrFemeas.value = QtdeF;
...
function ValidarCampos()
{
	...
	ArrayMsg[1] = " - Informar a Data de Nasimento;\n";
...
<Form name="Formulario" method="post" OnSubmit="return Validar()" action="NinhadaEstrangeira_Processar.php">
<input type="hidden" name="Action" value="<? echo($Action)?>">
<input type="hidden" name="Id" value="<? echo($Id)?>">
  <table>
    <tr> 
      <td><h3>Registro de Ninhadas Extrangeiras</h3></td>
    </tr>
    <tr> 
      <td>	
	  ...
	  <legend>
        ...
        <table class="SemBorda">
          <tr> 
            ...
            <td>&nbsp;</td>
            <!--td><div align="right">Ninhada</div></td-->
            <td><input name="IdNinhada" type="hidden" value="<?echo($NuNinhada)?>" size="8" maxlength="7" disabled title="O Número da Ninhada é Gerado Automaticamente"></td>
            <!--td>/</td-->
            <td><input type="hidden" name="NrAnoNinhada" size="5" maxlength="4" value="<? echo($AnoNinhada)?>" disabled></td>
          </tr>
        </table>
        ...
        <table align="center" class="SemBorda">
          <tr> 
            ...
            <td><input name="NoCanil" type="text" value="<?echo($NoCanil);?>" size="70" maxlength="50" readonly title="Não digite, escolha o Canil clicando no Botão ao lado"> 
	  ...
	  <legend>
	    ...
	    <table align="center" class="SemBorda">
          <tr> 
            <td>Consaguinidade</td>
          </tr>
          <tr> 
            <td><textarea name="TxConsaguinidade" cols="87" rows="3"><? echo($TxConsaguinidade);?></textarea></td>
          </tr>
        </table>
