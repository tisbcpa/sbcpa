...
<?
	...
	//$sql = "Select DSRaioX, Count(NORaioX) as Total From  (TBCachorro as a Inner Join TBNinhada as b on a.IDNinhada = b.IDNinhada) Inner Join TBRaioX as c On a.IdRaioX = c.IdRaioX Where  b.IDCachorroPai = $IdPai and b.DaNascimento Between '$DTInicio2'  and '$DTTermino2' Group By NORaioX";
