...
$IdCachorro = $_GET["Id"];
//$max = getrandmax();
//$numero = mt_rand(120,$max);
//$Senha =  $IdCachorro . "." . $numero;
//$Senha =  $numero;
...
$pdf -> addText(700,419,10,$RegistroNacional,'full');
//$pdf -> addText(918,421,10,$NuCBKC,'full');
//$pdf -> addText(961,421,10,'_______________','full');

$pdf -> addText(700,380,10,$Nome,'full');
$pdf -> addText(700,366,10,$Sexo,'full');
$pdf -> addText(853,366,10,$Cor,'full');

$pdf -> addText(710,353,10,$DataNascimento,'full');
$pdf -> addText(700,341,10,$Tatuagem,'full');
$pdf -> addText(700,328,10,$Microchip,'full');


$pdf -> addText(935,380,10,$Criador,'full');
$pdf -> addText(945,366,10,$Endereco,'full');
$pdf -> addText(940,353,10,$Cidade,'full');
$pdf -> addText(940,341,10,$Estado,'full');
$pdf -> addText(940,328,10,$Ninhada,'full');
...
$PosLinha = 295;
$LarguraCao = 43;
$TexoRet = QuebraLinhaTexto($TaxaConsaguinidade,$LarguraCao);
