...
else
{
	...
	if ($SumulaPaiReselecao == ""){ $SumulaPaiReselecao = "";}
	if ($JuizPaiReselecao != ""){ $JuizPaiReselecao = "JUIZ: " . $JuizPaiReselecao;}
	...
	if ($SumulaMaeReselecao == ""){ $SumulaMaeReselecao = "";}
	if ($JuizMaeReselecao != ""){ $JuizMaeReselecao = "JUIZ: " . $JuizMaeReselecao;}
	...
	if ($SumulaAvo1Reselecao == ""){ $SumulaAvo1Reselecao = "";}
	if ($JuizAvo1Reselecao != ""){ $JuizAvo1Reselecao = "JUIZ: " . $JuizAvo1Reselecao;}
	...
	if ($SumulaAvo2Reselecao == ""){ $SumulaAvo2Reselecao = "";}
	if ($JuizAvo2Reselecao != ""){ $JuizAvo2Reselecao = "JUIZ: " . $JuizAvo2Reselecao;}
	...
	if ($SumulaAvo3Reselecao == ""){ $SumulaAvo3Reselecao = "";}
	if ($JuizAvo3Reselecao != ""){ $JuizAvo3Reselecao = "JUIZ: " . $JuizAvo3Reselecao;}
	...
	if ($SumulaAvo4Reselecao == ""){ $SumulaAvo4Reselecao = "";}
	if ($JuizAvo4Reselecao != ""){ $JuizAvo4Reselecao = "JUIZ: " . $JuizAvo4Reselecao;}	
...
$pdf -> addText(650,421,10,$RegistroNacional,'full');
$pdf -> addText(918,421,10,$NuCBKC,'full');
$pdf -> addText(961,421,10,'_______________','full');

$pdf -> addText(650,386,10,$Nome,'full');
$pdf -> addText(650,371,10,$Sexo,'full');
$pdf -> addText(780,371,10,$Cor,'full');
$pdf -> addText(650,356,10,$DataNascimento,'full');
$pdf -> addText(650,341,10,$Tatuagem,'full');
$pdf -> addText(650,326,10,$Microchip,'full');
$pdf -> addText(920,386,10,$Criador,'full');
$pdf -> addText(920,371,10,$Endereco,'full');
$pdf -> addText(920,356,10,$Cidade,'full');
$pdf -> addText(920,341,10,$Estado,'full');
$pdf -> addText(920,326,10,$Ninhada,'full');
...
for ($i=0; $i<=$Tam; $i++)
{
	...
	$Frase = $Valores[$i];
	$pdf -> addText(650,$PosLinha,11,$Frase,'full');
}
...
for ($i=1; $i<=$Tam; $i++)
{
	$PosLinha = $PosLinha - 15;
	$Frase = $Valores[$i];
	$pdf -> addText(918,$PosLinha,11,$Frase,'full');
}
