...
$pdf -> addText(700,$LinhaAgora,$tamanho2,$RegistroNacional,'full');
$pdf -> addText(938,$LinhaAgora,$tamanho2,$NuCBKC,'full');
//$pdf -> addText(961,421,10,'_______________','full');

$LinhaAgora = 380 + $PosLinhaInicialPagina1;
$pdf -> addText(700,$LinhaAgora,$tamanho1,$Nome,'full');
$LinhaAgora = 366 + $PosLinhaInicialPagina1;
$pdf -> addText(700,$LinhaAgora,$tamanho1,$Sexo,'full');
$pdf -> addText(815,$LinhaAgora,$tamanho1,$Cor,'full');

$LinhaAgora = 353 + $PosLinhaInicialPagina1;
$pdf -> addText(710,$LinhaAgora,$tamanho1,$DataNascimento,'full');
$LinhaAgora = 341 + $PosLinhaInicialPagina1;
$pdf -> addText(700,$LinhaAgora,$tamanho1,$Tatuagem,'full');
$LinhaAgora = 328 + $PosLinhaInicialPagina1;
$pdf -> addText(700,$LinhaAgora,$tamanho1,$Microchip,'full');

$LinhaAgora = 380 + $PosLinhaInicialPagina1;
$pdf -> addText(950,$LinhaAgora,$tamanho1,$Criador,'full');
$LinhaAgora = 366 + $PosLinhaInicialPagina1;
$pdf -> addText(950,$LinhaAgora,$tamanho1,$Endereco,'full');
$LinhaAgora = 353 + $PosLinhaInicialPagina1;
$pdf -> addText(950,$LinhaAgora,$tamanho1,$Cidade,'full');
$LinhaAgora = 341 + $PosLinhaInicialPagina1;
$pdf -> addText(950,$LinhaAgora,$tamanho1,$Estado,'full');
$LinhaAgora = 328 + $PosLinhaInicialPagina1;
$pdf -> addText(950,$LinhaAgora,$tamanho1,$Ninhada,'full');
...
for ($i=0; $i<=$Tam; $i++)
{
	...
	$Frase = $Valores[$i];
	$pdf -> addText(685,$PosLinha,$tamanho1,$Frase,'full');
}
...
for ($i=1; $i<=$Tam; $i++)
{
	$PosLinha = $PosLinha - 15;
	$Frase = $Valores[$i];
	$pdf -> addText(930,$PosLinha,$tamanho1,$Frase,'full');
}
