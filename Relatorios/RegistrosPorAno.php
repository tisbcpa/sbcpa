...
<?
	...
	$sql = "select SgUF as SgUFRegistro, sum(a.NrMachosVivos) + sum(a.NrFemeasVivas) as Total from tbninhada as a, tbcanil as b where a.IdCanil = b.IdCanil and right(NuNinhada,4) = '$Ano' Group By SgUF";
