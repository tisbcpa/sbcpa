...
<?
	$sql = "Select a.NuRegistroNacional, a.NoCachorro from TBCachorro as a, TBSumula as b Where 	Year(b.DtSumula) = $Ano and a.IdSelecao = $Selecao and a.IdCachorro = b.IdCachorro Order by a.NuRegistroNacional";
	$sql_result = mysql_query($sql,$Conn) or die("<p class='MsgErro'>Query invalida: " . mysql_error() . "</p>");
	...
	{
		$Soma = $Soma + 1;
		echo("<tr><td align=Center>$row[NuRegistroNacional]</td><td align=Center>$row[NoCachorro]</td></tr>");
	}
